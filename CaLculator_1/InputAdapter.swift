...
func enterUtility(_ symbol: Operation){
        ...
        case .mul :
            ...
            if input == nil || input == "" || input == "0"
            {input = "0"}
            else if  input.characters.last == "+" || input.characters.last == "-" || input.characters.last == "×" || input.characters.last == "÷" || input.characters.last == "^" || input.characters.last == "!" {
                input.characters.removeLast()
                input = input + ("×")
            }
            else{
        ...
        case .factor :
            ...
            else if input.characters.last! >= "0" && input.characters.last! <= "9"  {
                input = input + ("!")
            }
            brain.enterEquation(equation: input)
        case.clear :
        ...
        case.clearS :
            if input.characters.count >= 1 {
                if input.characters.last == "(" || input.characters.last == ")"{
                ParenthesesCount = ParenthesesCount - 1
                }
                input.characters.removeLast()
                brain.enterEquation(equation: input)
